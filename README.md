...
| **2025 AI Chip Camp AI반도체 활용 및 응용**<br>*(12시간)* | **한국정보통신진흥협회 (KAIT)**<br>`2025.05.26 - 2025.05.28` | • LPU(LLM Processing Unit) 아키텍처 구조 및 동작 개념 학습<br>• AI 반도체 활용 및 응용 기술 교육 이수 |
